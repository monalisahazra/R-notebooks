...
## if the value is "Placed",then print "The student is placed from campus plament drives".
## if it is "Not PLaced",then print "THe student is not placed from campus placement drives".
...
## if it's "Credit card(automatic)",then print "The customer is using credit card as their payment method".
## if it's "Mailed check", then print "The customer is using mailed check for payment"
## if it's "Electronic check", then print "The customer is using electronic check for payment"
```{r}

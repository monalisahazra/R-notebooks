...
**if it's "Science", then add 5 extra marks in degree_p score.**
**if it's "Commerce",then add 3 extra marks in degree_p score.**
```{r}
...
**if it's "Others",then add 3 as grace marks in hsc_p for the 74th row.**
**if it's "Central",then add 5 as grace marks in hsc_p for the 74th row.**
```{r}
...
###Check 14th row of Internet Service column in the customer churn datasset:
